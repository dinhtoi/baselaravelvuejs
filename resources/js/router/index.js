...
* meta : {
    ...
    activeMenu: '/dashboard/index'  if set path, the sidebar will highlight the path you set
  }
**/
    ...
    children: [
      {
        ...
        name: 'Dashboard',
        meta: { title: 'dashboard', icon: 'dashboard', noCache: false, activeMenu: '/dashboard/index' },
      },
    ],
  },
  {
